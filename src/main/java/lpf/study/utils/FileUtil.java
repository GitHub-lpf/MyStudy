...
public class FileUtil {
    ...
    /**
     * @Description 批量删除<br/>
     * @param delIds 需要删除的Ids   1,2,3,4,
     * @return Set<String>  {1,2,3,4}
     */
    public Set<String> deleteSomeFile(String delIds ){
    ...
    /**
     * @Description 文件磁盘清理<br/>
     * @param fileRealPathList
     * @throws IOException
     */
    public static void  cleanFiles(List<String> fileRealPathList) throws IOException {
